...
if [ $# -ne 1 ]
then
echo "missing the expected arguments, usage: sfm.sh https://ashok-amsamani.s3.amazonaws.com/CCDefaulters/insuranceinfo.csv"
exit 0
fi
...
#wget https://ashok-amsamani.s3.amazonaws.com/CCDefaulters/insuranceinfo.csv -O /tmp/clouddata/creditcard_insurance
#-O => copies all content to mentioned file (creditcard_insurance.
