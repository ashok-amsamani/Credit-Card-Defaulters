...
#echo $(basename '/user/hduser/insurance_clouddata/creditcard_insurance_2020102520');
#creditcard_insurance_2020102520
#echo $(dirname '/user/hduser/insurance_clouddata/creditcard_insurance_2020102520');
#/user/hduser/insurance_clouddata
...
#The -d option allows you to operate on a specific date.
...
#LOAD DATA INPATH '/user/hduser/insurance_clouddata/creditcard_insurance_2020102520' OVERWRITE INTO TABLE insure.insurance PARTITION (datadt='2020-10-25',hr=20)
